...
public extension XCTestCase {
     ...
     */
    func waitForHittable(element: XCUIElement, waitSeconds: Double, file: String = #file, line: Int = #line) {
     ...
     */
    func waitForNotHittable(element: XCUIElement, waitSeconds: Double, file: String = #file, line: Int = #line) {
        waitForExpectation(element: element, expectation: "hittable == false", waitSeconds: waitSeconds, file: file, line: line)
    }
    
    func waitForExists(element: XCUIElement, waitSeconds: Double, file: String = #file, line: Int = #line) {
        waitForExpectation(element: element, expectation: "exists == true", waitSeconds: waitSeconds, file: file, line: line)
    }
    
    func waitForNotExists(element: XCUIElement, waitSeconds: Double, file: String = #file, line: Int = #line) {
        waitForExpectation(element: element, expectation: "exists == false", waitSeconds: waitSeconds, file: file, line: line)
    }
    
    func waitForEnabled(element: XCUIElement, waitSeconds: Double, file: String = #file, line: Int = #line) {
        waitForExpectation(element: element, expectation: "enabled == true", waitSeconds: waitSeconds, file: file, line: line)
    }
    
    func waitForNotEnabled(element: XCUIElement, waitSeconds: Double, file: String = #file, line: Int = #line) {
     ...
     */
    func waitForExpectation(element: XCUIElement, expectation expectationPredicate: String, waitSeconds: Double, file: String = #file, line: Int = #line) {
